...
import (
	...
	application "github.com/acpereira/go-hexagonal/application"
...
func (m *MockProductServiceInterface) Disabled(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductServiceInterfaceMockRecorder) Disabled(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Disabled", reflect.TypeOf((*MockProductServiceInterface)(nil).Disabled), product)
}
